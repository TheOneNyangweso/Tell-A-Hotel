        ...
        <div className="md:grid md:grid-cols-12 gap-10 px-3">
          <div className="md:col-span-8 md:w-full">
            <div>
              ...
              <div className="shadow dark:shadow-white rounded-lg p-6 border">
          ...
          <div className="md:col-span-4 rounded-xl shadow-lg dark:shadow dark:shadow-white sticky top-10 h-fit overflow-auto rainbow-border">
            <BookRoomCta
